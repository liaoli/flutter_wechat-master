...
class _MainScaffoldState extends State<MainScaffold> {
  ...
  void initState() {
    ...
    menuItems
        .add(ItemModel(Ids.receive_payment.str(), 'menu_add_newmessage', 3));
    super.initState();
  }
    ...
    return MyScaffold(
      ...
      actions: [
        TapWidget(
            ...
            child: Image.asset(
              Utils.getImgPath('icon_search', dir: 'icon'),
              width: 50.w,
              height: 50.w,
            )),
        20.sizedBoxW,
  ...
  Widget _buildCustomPopupMenu() {
    return CustomPopupMenu(
      child: Image.asset(
        Utils.getImgPath('add_addressicon', dir: 'icon'),
        width: 40.w,
        height: 40.w,
                  ...
                  .map(
                    (item) => TapWidget(
                      onTap: () async {
                        ...
                        switch (item.type) {
                          case 0:
                            var _selectedList = await NavigatorUtils.toNamed(
                                SelectFriendPage.routeName,
                                arguments: SelectFriendArguments(
                                    title: Ids.create_chat.str()));
                            if (_selectedList != null) {
                              ChatManagerController.instance
                                  .createConversation(_selectedList);
                            }
                            break;
                          case 1:
                            ...
                            break;
                          case 2:
                            var result = await NavigatorUtils.toNamed(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: <Widget>[
                            Image.asset(
                              Utils.getImgPath(item.icon, dir: 'icon'),
                              width: 50.w,
                              height: 50.w,
                            ),
                            Expanded(
